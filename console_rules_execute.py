...
def detection(rule,path_list, ip_network,ip_network1,size_list):
    ...
    detection_py_rules(rule,path_list, ip_network,ip_network1,size_list)

cli.add_command(detection)
